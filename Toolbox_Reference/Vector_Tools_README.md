...
Runs Zonal Statistics as Table, calculates a selected raster statistic, and joins the metric back to the zone features.
...
Snaps a culvert pour point to the highest nearby flow accumulation cell and delineates its drainage area.
...
Identifies the dominant class within each zone from a long-format summary table.
